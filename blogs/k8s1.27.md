...
![k8s 1.27 release](./imgs/1.27.png)
...
![APIServerTracing](./imgs/trace.png)
...
- 张世明主要维护的项目 KWOK (Kubernetes Without Kubelet) 成为社区热点，并在大规模集群模拟方面有效地节约资源，提升效率。
- 要海峰几乎包揽了近期官网博客的翻译，并成为 SIG-docs-zh 的维护者。
- 刘梦姣也是 SIG-docs 的维护者。
- 殷纳在即将召开的 **2023 年欧洲 KubeCon 上，将分享两个有趣的调度方向的主题，分别是 “Sig Scheduling Deep Dive”
  和 “Building a Batch System for the Cloud with Kueue” （属于 Kubernetes Batch + HPC Day）。
- 徐俊杰将分享 “Kubeadm Deep Dive” 的主题。**
